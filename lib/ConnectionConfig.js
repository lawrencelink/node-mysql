...
function ConnectionConfig(options) {
  if (typeof options === 'string') {
    //what is this options stuff, does the user pass the options to the .parseUrl function 
    //cause I saw that the .parseUrl function receives a url parameter
    //how can options place a variable of the same name into a function??
    options = ConnectionConfig.parseUrl(options);
  }

//Setting up the ConnectionConfig parameters
